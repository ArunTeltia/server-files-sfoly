...
<head>
    ...
    <meta name="keywords"
        content="Olympiads, olympiad , maths olympiads , Science olympiads ,national olympiads, springfield olympiads, competitive olympiads,science, arithmetic, computer training, English, General Knowledge, and other expert courses  ">
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <br /><br /><br /><br /><br /><br />
    <center>
        <h1>Springfield International Maths Olympiad (SIMO)</h1>
    </center>
    <div class="container-fluid" id="olympiad">
        <div class="card">
            <div class="card-body">
                <br />
                <p> <i class="fas fa-graduation-cap"></i>The <span title="SIMO">Springfield International Maths Olympiad
                        (SIMO)</span>, a test of competence and knowledge in the subject of Maths, is held based on
                ...
                <p><i class="fas fa-user-alt-slash"></i>For the year 2020, the SIMO is scheduled for November 29. You
